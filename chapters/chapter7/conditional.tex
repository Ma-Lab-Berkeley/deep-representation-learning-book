...
posterior sampling). \sdb{TODO: Ask Liyue about figure of MRI visual results.}
...
\begin{table}[t]
    ...
    \begin{tabular}{@{}lccc@{}}
        ...
        \bottomrule
    \end{tabular}
    \caption{\textbf{MRI reconstruction results} comparing diffusion
    posterior sampling approaches across different acceleration factors (the
    degree of Fourier space subsampling in $\cS$) on the BraTS MRI
