...
\section{Informative Representation and Information Gain}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{figs_chap3/Gaussian-Subspaces.png}
...
\end{equation}
The optimal network parameters $\bm \theta $ is typically found through optimizing the above objective through an efficient gradient descent scheme such as the back propagation (BP) described in Section \ref{app:BP-section} of Appendix \ref{app:optimization}.
...
{From the achievable (entropy) to an implementable coding scheme. That is, in addition to a computable or achievable encoding scheme, there should also exist an implementable decoding scheme. Lossy quantification becomes necessary for real-valued data.} \pw{Add some references on computational and sampling efficiency of diffusion models and discuss these results.}
