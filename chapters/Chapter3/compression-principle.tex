...
\begin{remark}
	...
	\DP{The first two rates are slightly wrong. ONe has that the covering number \(N_{\eps}(\vx)\) has \(N_{2\eps}(\vx) \leq \cR_{\eps}(\vx) \leq N_{\eps}(\vx)\) in the small \(\eps\) regime. This allows squeeze-theorem like statements which prove forms of the first two identities below, albeit with slightly different constants.}
