...
\begin{document}
\section{Planned Integrations for v2.0}



\subsection{Chapter 3 Revamp (Peng, Druv, and Qing)}
...
\subsection{Chapter 4: Causal architectures (Ziyang and Druv)}
...
\subsection{Chapter 5 Revamping (Sam, Ziyang, and Yi)}
...
\subsection{Chapter 6 Editing (Sam, Yi)}
\begin{itemize}
...
\subsection{Chapter 7 New Applications (Team)}
\begin{itemize}
...
\subsubsection{Refactoring and reorganization}
...
\subsubsection{Figures replacement}

\begin{itemize}
    \item Replace many placeholder figures with more finalized versions
\end{itemize}

\subsubsection{Deeper code/data integration and open-sourcing}
...
\subsubsection{Slides and teaching material open-sourcing}
