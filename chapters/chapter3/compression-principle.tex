...
\label{ch:general-distribution}\label{ch:denoising}\label{ch:compression}
...
\begin{remark}[Linear Discriminative Analysis] One may notice that the second criterion resembles that of the classic {\em  linear discriminant analysis} (LDA)~\cite{HastieTiFr09}.
    ...
    \begin{figure}
	\centering
	\includegraphics[width=0.75\linewidth]{\toplevelprefix/chapters/chapter3/figs/LDA.png}\vspace{-0.1in}
...
\subsection{Supervised Learning with Class Information}
...
\subsection{Unsupervised Learning via Contracting and Contrasting}
