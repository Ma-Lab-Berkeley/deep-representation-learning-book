...
% the resolution to the negative infinity different paradox is the lossy coding/rate
...
% \begin{theorem}[Theorem 2.2 of \cite{lee2022convergence}, Abbreviated]\label{thm:distribution-convergence}
