...
Here, 
 and 
 are the predefined hyperparameters that control the added noise schedule, and 
 is a weight function for the training loss. If we parameterize the DAE 
 according to the form of the optimal posterior estimator of the above MoLRG distribution—where the subspace 
