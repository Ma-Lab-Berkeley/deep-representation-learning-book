...
\begin{theorem}[Simplified Version of \Cref{thm:diffusion_entropy_increases}]
    ...
    \end{equation}
    i.e., the entropy of the distribution of the noised \(\vx\)
    increases over time \(t\).
\end{theorem}
...
\end{equation}
recalling that \(\tau \sim \dUnif([0, T])\). For the sake of
completeness we will mention that other targets have
...
The calculation presented at the end of the last
