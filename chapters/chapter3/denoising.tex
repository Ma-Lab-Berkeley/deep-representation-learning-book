...
\begin{figure}[t]
	...
	\caption{\small Co-emergence of reproducibility (3a) and generalizability (3b) of UNet architectures with three different parameter numbers (UNet-64, UNet-128, and UNet-256) in the denoising diffusion probabilistic model, which is trained on a varying number of images from the CIFAR-10 dataset. 
}
