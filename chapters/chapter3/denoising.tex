...
However, the complexity of image distributions makes it difficult to rigorously verify our claim regarding image datasets. To mathematically understand generalization behavior, let us consider a simple example of the mixture of low-rank Gaussian (MoLRG) distribution: 
\begin{align}
