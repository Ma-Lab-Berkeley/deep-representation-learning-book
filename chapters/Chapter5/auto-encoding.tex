...
The remaining term involves our encoder and decoder simultaneously: we can see
it corresponds to an autoencoding loss by calculating
\begin{align*}
  \bE_{\vx}
  \bE_{\vz \sim q(\,\cdot\, \mid \vx ; \vphi)} \left[
    \log p(\vx \mid \vz; \vtheta)
...
\sdb{Align Visual Data with Texts, ControlNet, ... DALLE type architecture for text-conditioned image generation?}
