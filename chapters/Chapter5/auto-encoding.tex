...
\end{align*}
we take expectations with respect to $\vz \sim q(\,\cdot\, \mid \vx;\, \veta)$ and
...
posterior concentrates on its mean $f_1(\vx)$, for every $\vx$: this is the limit
...
objective (\Cref{eq:elbo-for-gaussians}), given individual samples $\vx$ from the
