...
\begin{example}\label{example:denoising-conditional-gaussian}
  ...
  \begin{figure}[tbp]
    ...
    converging to the posterior $p_{\vx \mid \vy}$. The convergence dynamics are
    similar. \textbf{Bottom:} For smaller observation noise $\sigma = 0.1$, the
  ...
  \sdb{TODO: Write a more mechanistic explanation of
  \Cref{fig:conditional_sampling_computational_gaussian}, we could go into
  details about why the collapse is happening here more carefully.}
