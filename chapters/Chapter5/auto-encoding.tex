...
between a normal (Guassian) distribution $p(\x_T) =
...
\log p(\vx_t)}\big)dt  + d\vw_t.
\end{eqnarray}

Below we give some vignettes about solving several typical
...
introduced into the (iterative denoising) deep architecture with
different means.
