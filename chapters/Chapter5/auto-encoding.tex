...
\section{Data Completion via Autoencoding}
\label{sec:MAE}
\yima{A good autoencoding should enable us to utilize the learned distribution and representation for various estimation and generation tasks under different conditions, either on $\x$ or in particular on the learned $\z$. That is easy to exploit the joint distribution ($\x, \z$).}
