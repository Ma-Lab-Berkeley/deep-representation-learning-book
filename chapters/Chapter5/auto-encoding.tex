...
To generalize the above completion, we may consider that $\X$ is observed through a more general function $\Y = h(\X)$, and we want the learned autoencoder to allow us to sample the condition distribution $p(\X\mid \Y)$. 
...
models to learn such a conditional autoencoder for images 
