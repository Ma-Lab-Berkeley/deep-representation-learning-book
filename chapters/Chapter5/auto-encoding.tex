...
The fundamental purpose of autoencoding is indeed to grant \textit{control} over the distribution of the data. In the previous sections, we have developed the methodology of autoencoding in an abstract,
