...
We use a CRATE encoder and decoder, depicted in \Cref{fig:transformer_backbone}\pw{Is this reference correct?}, though of course it is possible to use a regular transformer encoder and decoder. Details follow now.
