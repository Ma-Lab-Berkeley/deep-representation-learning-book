...
\end{quote}
Only by knowing the difference can we possibly attempt to provide a meaningful answer to the question: ``Can machine understand?''

Probably much more importantly, how to verify whether a self-claimed intelligent system is capable of {\em creating new knowledge and correcting its own knowledge}, such as creating new mathematical concepts and discovering new physical laws and causal relationships? The connection between understanding and self-creation might be rather fundamental, as the Physistist Richard Feynman has put it:
\begin{quote}
    \centering
...
\begin{enumerate}
    \item having merely learned the distribution of some knowledge-carrying data and being able to regenerate them;
    \item being capable of autonomously and continuously creating new knowledge or correcting existing one from new observations and experiences;
    \item being able to truly  understand abstract concepts, rules and laws and knowing how to apply them correctly in a deductive manner;
    \item being able to generate new scientific hypotheses and mathematical conjectures and verify or falsify them based on experimentation or logic deduction.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \textit{The Karl Popper test:} to determine whether a system can proactively explore and create new abstract knowledge by forming and verifying theories based on experimental consistency or logic self-consistency.
\end{enumerate}
...
\end{quote}
Only by knowing the difference can we attempt to provide a meaningful answer the question: ``Can machine abstract or create?''
