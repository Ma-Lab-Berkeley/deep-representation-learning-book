...
As an open-source book, the first version, entitled ``Learning Deep Representations of Data Distributions'', released on August 18, 2025 has been frequently and constantly updated in the past six months. Meanwhile, based on
...
Hence, we have decided to make some substantial changes and upgrades of the content and organization of the book with a new \textit{Version 2.0}, now entitled:\\
\centerline{\em Principles and Practice of Deep Representation Learning}\\
\centerline{\em \small (A Mathematical Theory of Structured Memory)}\\ The new version also allows us to explicitly reveal strong conceptual and technical connections among materials across different chapters and sections within the book, so that the overall pedagogical value of the book, we believe, has been improved significantly over the first version. 
