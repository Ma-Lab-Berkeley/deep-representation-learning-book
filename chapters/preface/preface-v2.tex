...
\centerline{\em ``Structured Memory:\\ Principles and Practice of Deep Representation Learning''.}\\ The new version also allows us to explicitly reveal strong conceptual and technical connections among materials across different chapters and sections within the book, so that the overall pedagogical value of the book, we believe, has been improved significantly over the first version. 
