...
In our opinion, the new version gives a much more unified and stream-lined presentation of this subject that it deserves. The new version also incorporates quickly improved theoretical insights on this important subject as well as an explosively growing number of practical applications for real-world data that have not been systematically documented elsewhere. That makes the Version 2.0 more timely and complete.
