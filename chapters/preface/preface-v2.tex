...
As an open-source book, the first version released on August 18, 2025 has been
frequently and constantly updated in the past six months. Meanwhile, based on
our experience from using the book for a new course taught at the University of
Hong Kong in Fall 2025 and feedback that we have received from colleagues,
teaching assistants and students, we have identified numerous points throughout
the book that merit further revision and expansion.

Hence, we have decided to make some substantial changes and upgrades of the
content and organization of the book with a new \textit{Version 2.0}. The new version also allows us to explicitly reveal strong conceptual and technical connections among materials across different chapters and sections within the book, so that the overall pedagogical value of the book, we believe, has been improved significantly over the first version.
