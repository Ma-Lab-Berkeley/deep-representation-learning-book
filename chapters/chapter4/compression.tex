...
We here present how the MCR$^2$ objective \eqref{eqn:maximal-rate-reduction} helps learn better representations than the cross entropy (CE) \eqref{chap4-eqn:cross-entropy} for image classification. Here we adopt the popular neural network architecture, the ResNet-18~\cite{he2016deep}, to model the feature mapping $\z = f(\x,\theta)$. We optimize the neural network parameters $\theta$ to maximize the coding rate reduction. More implementation details of this experimental can be found in \cite{chan2021redunet}. 
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{chapters/chapter4/figs/Table1.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{chapters/chapter4/figs/visual_2class.pdf}
