...
\end{equation}
Clear characterization and distinction are necessary because we want to study intelligence as a scientific and mathematical subject. Although all forms may share the common objective of learning and improving knowledge about the world, the computational mechanisms and physical implementations could differ. We believe the reader will better understand and appreciate their commonality and difference after studying this book. Therefore, we leave deeper scientific or philosophical discussions on the relationship among these different forms of intelligence  to the end of the book \Cref{ch:future}.
...
\end{equation}
As we will see in \Cref{ch:compression} and \Cref{ch:lossy-compression}, the achievable minimal rate is closely related to the notion of entropy \(H(S)\) \eqref{eqn:entropy-definition}.
...
\end{equation}
in \Cref{ch:compression}, \Cref{sec:consistent-representation} and \Cref{sec:self-consistency} of \Cref{ch:autoencoding}, respectively. 
...
\begin{enumerate}
    ...
    \item a diffusion and denoising process between the learned representation $\Z$ and random noise $\boldsymbol{G}$.
\end{enumerate}
...
\begin{equation*}
    \operatorname{Intelligence}(t) = \odv*{\operatorname{Information}}{t}(t), \quad 
