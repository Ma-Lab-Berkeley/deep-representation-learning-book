...
At sampling time, \sdb{ADD CG ALGO}
...
that of the denoiser. This motivated \citet{Ho2022-ry} to propose a more
empirically pragmatic methodology, known as classifier-free guidance (CFG).
\sdb{CFG...}
