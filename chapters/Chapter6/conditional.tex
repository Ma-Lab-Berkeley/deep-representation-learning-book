...
\begin{figure}
  \centering 
  \includegraphics[width=0.9\textwidth]{chapters/chapter6/figs/inference_roadmap.pdf}
...
The popular natural image completion and natural language prediction are two typical tasks that require us to recover a full data $\x$ from its partial observations $\y$, with parts of $\x$ masked out and to be completed based on the rest. Figure \ref{fig:image-text-completion} shows some examples of such tasks. In fact, it is precisely these tasks which have inspired how to train modern large models for text generation (such as GPT) and image completion (such as the masked autoencoder) that we will study in greater details later.
    \begin{figure}
        \centering
        \includegraphics[height=0.4\linewidth]{chapters/chapter6/figs/image-completion.jpg} \hspace{10mm} \includegraphics[height=0.45\linewidth]{chapters/chapter6/figs/text-prediction.jpg}
...
% Notice that an augmented Lagrange multiplier method that enforces the constraint $F(\x) = \boldsymbol{0}$ via gradient ascent is equivalent to direct gradient ascent using Bayes' rule, the score associated with the probability density $p(\x)$, and the score associated with the conditional probability density $p(\y\mid \x)$ (in the space of $\x$). \DP{redundant, I think?}
...
% \begin{figure}
%     \centering
%     \includegraphics[width=0.8\linewidth]{chapters/chapter6/figs/Matrix-Completion.png}
...
\begin{figure}
\centering
% \includegraphics[width=0.3\linewidth]{chapters/chapter6/figs/Matrix-masked.png}
% \hspace{5mm}  \hspace{5mm}
% \includegraphics[width=0.3\linewidth]{chapters/chapter6/figs/Matrix-completed.png}
\includegraphics[width=0.3\linewidth]{chapters/chapter6/figs/masked-checkerboard.png}\;\;
\includegraphics[width=0.3\linewidth]{chapters/chapter6/figs/mask.png}\;\;
\includegraphics[width=0.3\linewidth]{chapters/chapter6/figs/checkerboard.png}
...
%\vspace{-0.5in}
\begin{center}
  \includegraphics[width=0.99\textwidth]{chapters/chapter6/figs/crate_mae_pipeline.png}
\end{center}
%\vspace{-0.1in}
...
%\vspace{-0.5in}
\centering
\includegraphics[width=0.99\textwidth]{chapters/chapter6/figs/crate_mae_layers.png}
%\vspace{-0.1in}
...
%\vspace{-0.5in}
\centering
\includegraphics[width=0.99\textwidth]{chapters/chapter6/figs/crate_mae_autoencoding_small.pdf}
%\vspace{-0.1in}
...
\begin{figure}
  \centering
  \includegraphics[width=1.0\textwidth]{chapters/chapter6/figs/ambient_diffusion.png}
...
\yima{Can we simply replace $\log p(\y \mid \x_t)$ with the measurement constraint $\|\y - h(\x_t)\|^2$ and use its gradient to replae the second term in the above equation?} \DP{It requires \(y \mid \vx_{t}\) to be like \(\dNorm(\vy; h(\vx_{t}), \sigma{2}\vI)\) where \(1/\sigma^{2}\) eventually becomes the learning rate. This assumption is fine to state but a bit unrealistic, IMO.}
...
\begin{example}\label{example:denoising-conditional-gaussian}
  ...
  \begin{figure}[tbp]
    ...
    \begin{subfigure}{0.32\textwidth}
      \includegraphics[width=\linewidth]{chapters/chapter6/figs/samples_step_000_t_100_largenoise.png}
      % \caption{}
      % \label{}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\textwidth}
      \includegraphics[width=\linewidth]{chapters/chapter6/figs/samples_step_050_t_50_largenoise.png}
      % \caption{}
      % \label{}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\textwidth}
      \includegraphics[width=\linewidth]{chapters/chapter6/figs/samples_step_100_t_0_largenoise.png}
      % \caption{}
      % \label{}
    \end{subfigure}
    ...
    % Bottom row (3 images)
    \begin{subfigure}{0.32\textwidth}
      \includegraphics[width=\linewidth]{chapters/chapter6/figs/samples_step_000_t_100_smallnoise.png}
      % \caption{}
      % \label{}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\textwidth}
      \includegraphics[width=\linewidth]{chapters/chapter6/figs/samples_step_010_t_90_smallnoise.png}
      % \caption{}
      % \label{}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.32\textwidth}
      \includegraphics[width=\linewidth]{chapters/chapter6/figs/samples_step_100_t_0_smallnoise.png}
      % \caption{}
      % \label{}
    \end{subfigure}
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=\linewidth]{chapters/chapter6/figs/pose-teaser.pdf}
    \caption{
...
\begin{figure*}[t]
  \centering
  \includegraphics[width=\linewidth]{chapters/chapter6/figs/pose-method.pdf}
\caption{
...
\begin{subfigure}{0.45\textwidth}
  \centering
  \includegraphics[width=\linewidth]{chapters/chapter6/figs/qual0_gt.png}
  \caption{\centering Ground-truth}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
  \centering
  \includegraphics[width=\linewidth]{chapters/chapter6/figs/qual0_ours.png}
  \caption{EgoAllo}
\end{subfigure}
...
\begin{subfigure}{0.45\textwidth}
  \centering
  \includegraphics[width=\linewidth]{chapters/chapter6/figs/qual1_gt.png}
  \caption{\centering Ground-truth}
\end{subfigure}
\hfill
\begin{subfigure}{0.45\textwidth}
  \centering
  \includegraphics[width=\linewidth]{chapters/chapter6/figs/qual1_ours.png}
  \caption{EgoAllo}
\end{subfigure}
...
\begin{figure}[tbp]
  ...
  \begin{subfigure}{0.47\textwidth}
    \includegraphics[width=\linewidth]{chapters/chapter6/figs/tti-train.pdf}
    \caption{}
    % \label{}
  \end{subfigure}
  \hfill
  \begin{subfigure}{0.47\textwidth}
    \includegraphics[width=\linewidth]{chapters/chapter6/figs/tti-inf.pdf}
    \caption{}
    % \label{}
  \end{subfigure}
  % \includegraphics[width=0.8\linewidth]{chapters/chapter6/figs/tti.pdf}
...
resolution is fixed. Cross attention (with $K$ heads, and no bias) is defined as
    \begin{equation}
      \mathrm{MHCA}(\vz_t, \vY^+) \label{eq:mhca}
        ...
        [\vU_{\key}^{K}]^{\top}\tau(\vY^+),
        [\vU_{\val}^{K}]^{\top}\tau(\vY^+))}, %+ \vb_{\out}\vone_{n}^{\top},
    \end{equation}
...
other applications, as in EgoAllo (\Cref{sub:ego-allo}).
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.7\linewidth]{chapters/chapter6/figs/3D-2D-projection.png}
...
\begin{figure}[t]
  \centering 
  \includegraphics[width=0.7\linewidth]{chapters/chapter6/figs/inference_distributed.pdf}
...
Notice that we have studied learning representations that are invariant to translation and rotation in a limited setting in Chapter \ref{ch:representation}. We know that the associated compression operators take the necessary form of (multi-channel) convolutions, hence lead to the (deep) convolution neural networks. Nevertheless, operators that are associated with compression or denoising that are invariant to more general transformation groups remain elusive to characterize \cite{eqvivariant-DNN}.  
