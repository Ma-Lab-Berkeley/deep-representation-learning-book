...
A typical problem of this kind is  body/hand gesture generation conditioned on a given head pose (sequence). Maybe a vignette for this.


\section{Conditional Generation with Paired Data}
\subsection{Class Conditioned Image Generation} 
Image generation with or without classifier guidance. 
