...
\sdb{Discussion of the connection between the $\Delta R$ connection in the
mixture of Gaussian setting, and cross-attention operators, which are used in
practical implementations of conditioning layers. Leads into the next vignette,
of generalized conditioning layers.}
