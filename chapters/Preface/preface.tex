...
\item To connect theory to practice, we will demonstrate how the learned data distributions and representations can be used in many applications for real-world tasks with large-scale data such as image classification, image completion, image segmentation, image generation, and similar tasks for text data. 
\end{itemize}
