...
\item To connect theory to practice, we will demonstrate many applications of the methods and algorithms developed in this book for real-world tasks with large-scale data such as image classification, image completion, image segmentation, image generation, and similar tasks for text data. 
\end{itemize}
