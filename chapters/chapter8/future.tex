...
\begin{table}[h]
    ...
    \textbf{Codebook}  & Amino Acids & Neurons & Alphabet \& Words & Mathematical  Abstractions \\ [0.5ex]
    \hline 
...
Despite the seemingly differences among these different stages of intelligence, the evolution of intelligence shares a common characteristic: {\em they all use certain form of feedback\footnote{error or reward} to improve information learned and the feedback is becoming increasingly frequent and efficient through the evolution.}

\subsection{The Emergence of Scientific Intelligence}
