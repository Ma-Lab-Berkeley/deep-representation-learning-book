...
\begin{table}[h]
    ...
    \textbf{Codebook}  & DNAs & Neurons/Brain & Natural Languages & Mathematical  Abstractions \\ [0.5ex]
    \hline 
...
\begin{enumerate}
    ...
    \item being capable of autonomously and continuously developing new knowledge from new observations;
    \item having truly understood certain abstract rules and laws and knowing how to apply them correctly;
    \item being able to generate new scientific hypotheses and mathematical conjectures and verify or falsify.
\end{enumerate}
