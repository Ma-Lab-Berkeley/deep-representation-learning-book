...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{\toplevelprefix/chapters/chapter8/figs/BPE1.png}\hspace{0.6in} 
...
\section{Representation Auto-Encoding via Diffusion and Denoising}
...
\subsection{Sampling from Learned Representations via Denoising and Diffusion}
