...
\end{figure}
Having explored methods for learning representations from 2D imagery, such as contrastive learning and masked autoencoding, we now turn to a significantly more challenging and ill-posed problem: inferring a complete 3D object structure from a single 2D image. This task lies at the heart of computer vision, aiming to reverse the physics of image formation. An image $\image$ is the result of a rendering process,
\[
