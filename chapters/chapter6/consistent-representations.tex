...
and the state of
the art in \Cref{sec:SimDINO}, where we describe ``open-loop'' representation learning
in SimDINO, and in \Cref{sec:RAE-implement}, where the ``representation autoencoder''
framework demonstrates how  representations learned from DINO/SimDINO can be combined with
