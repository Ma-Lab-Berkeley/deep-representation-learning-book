...
\begin{enumerate}
  ...
  \item The structured representation $\Z$ can be modeled approximately as a mixture of low-dimensional Gaussians so that we can learn a denoiser to efficiently access the distribution of $\Z$.
\end{enumerate}
