...
From nonlinear to linear and from dependent to independent, unrolled optimization that maximizes rate reduction or information gain to promote linearality and independence, via iterative compression and transformation. This chapter connects deep networks to the roots of iterative optimization via gradient descent. 




\section{The Principle of Maximal Information Gain}
...
\section{New Deep Architectures via Unrolled Optimization}
