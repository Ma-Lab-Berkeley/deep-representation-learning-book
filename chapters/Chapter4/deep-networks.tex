...
\begin{equation}
\bar \z \doteq \bm \tau \left( \big[\circm(\bm k_1) \x, \ldots, \circm(\bm k_C) \x \big]^* \right) \in \Re^{C \times d}.
...
\paragraph{Representation Learning via the Principle of Parsimony and Consistency.} 
