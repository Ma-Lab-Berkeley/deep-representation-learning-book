...
\begin{figure}
\centering
    \includegraphics[width=0.85\linewidth]{chapters/chapter4/figs/redu_gradient_diagram.png} 
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.65\linewidth]{chapters/chapter4/figs/expand_compress.png}
...
\begin{figure}[t]
    \begin{subfigure}[t]{0.35\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/redunet_layer.png}
        \caption{\textbf{ReduNet}}
    \end{subfigure}
    \hfill 
    \begin{subfigure}[t]{0.6\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/resnet_resnext.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.45\linewidth]{chapters/chapter4/figs/MoE.png} \hspace{5mm}
    \includegraphics[width=0.45\linewidth]{chapters/chapter4/figs/switched-transformer.png}
...
\begin{figure}[t]
    \begin{subfigure}[t]{0.32\textwidth}
        \centering 
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/scatter3d-X_train.pdf}\vspace{-0.1in}
        \caption{$\bm{X}_{\text{train}}$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering 
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/scatter3d-Z_train.pdf}\vspace{-0.1in}
        \caption{$\bm{Z}_{\text{train}}$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering 
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/scatter3d-loss-traintest.pdf}\vspace{-0.1in}
...
\begin{figure}[t]
    \begin{subfigure}[t]{0.4\textwidth}
        \centering 
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/ortho_diagram_1d.pdf}
    \end{subfigure}
    \hfill 
    \begin{subfigure}[t]{0.4\textwidth}
        \centering 
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/ortho_diagram_2d.pdf}
    \end{subfigure}
...
\begin{figure}[t]
	\centerline{
\includegraphics[width=0.9\textwidth]{chapters/chapter4/figs/sparse-representation.pdf}}
...
\begin{figure}[t]
	\centerline{
\includegraphics[width=0.95\textwidth]{chapters/chapter4/figs/sparse-lifting.pdf}}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.98\linewidth]{chapters/chapter4/figs/learn_to_classify_diagram_updated.png}
...
\begin{figure}[t]
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/1d-rotation.pdf}
        \caption{$\bm{X}_{\text{rotation}}$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/mnist1d_img0.pdf}
        \caption{$\bm{Z}_{\text{rotation}}$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/mnist1d_img1.pdf}
        \caption{Loss}
    \end{subfigure}
...
\begin{figure}[t]
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/mnist1d-heatmap-X_translate_train_all.pdf}
        \caption{$\bm{X}_{\text{rotation}}$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/mnist1d-heatmap-Z_translate_train_all.pdf}
        \caption{$\bm{Z}_{\text{rotation}}$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.32\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/mnist1d-loss-traintest.pdf}
        \caption{Loss}
    \end{subfigure}
...
% \begin{figure}
%     \centering
%     \includegraphics[width=0.95\textwidth]{chapters/chapter4/figs/image_eps_ball.png}
...
\begin{figure}[t!]
     \centering
         \includegraphics[width=0.95\textwidth]{chapters/chapter4/figs/coding-transform.png}
...
\begin{figure}
     \centering
     \includegraphics[width=0.75\textwidth]{chapters/chapter4/figs/crate_encoder_architecture.pdf}
...
\begin{figure}[t!]
     \centering
         \includegraphics[width=\textwidth]{chapters/chapter4/figs/CRATE_fig1_patches.pdf}
     \vspace{-0.1in}
     \caption{
...
% \begin{figure}
%      \centering
%      \includegraphics[width=0.99\textwidth]{chapters/chapter4/figs/crate_compression_sparsification.pdf}
...
\begin{figure}[t]
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/forward.png}
        \caption{\bf Forward pass}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/backward.png}
...
\begin{figure}[t]
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/SNR1.png}
        \caption{Noise level $\delta = 0.2$}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \includegraphics[width=\textwidth]{chapters/chapter4/figs/SNR2.png}
...
\begin{figure*}[t]
\begin{center}
        \includegraphics[width=0.75\textwidth]{chapters/chapter4/figs/MSSA.png}
...
\begin{figure}[t]
    \centering \includegraphics[width=1\textwidth,trim={0 5.0cm 0 0},clip]{chapters/chapter4/figs/V-CRATE.pdf}
    \vspace{-1mm}
