...
%     \includegraphics[width=0.22\textwidth]{\toplevelprefix/chapters/chapter4/figs/redunet/mnist1d/class_all/heatmap-X_translate_train_all.pdf}
%     }
%     \subfigure[\label{fig:1d-invariance-plots-b}$\bar{\Z}_{\text{shift}}$ (RI-MNIST)]{
%     \includegraphics[width=0.22\textwidth]{\toplevelprefix/chapters/chapter4/figs/redunet/mnist1d/class_all/heatmap-Z_translate_train_all.pdf}
%     }
%     \subfigure[\label{fig:1d-invariance-plots-c}Similarity (RI-MNIST)]{
%     \includegraphics[width=0.23\textwidth]{\toplevelprefix/chapters/chapter4/figs/redunet/mnist1d/class_all/sample_angle_combined-Z-translate_train_all-vs-translate_test_all.pdf}
%     }
%     \subfigure[\label{fig:1d-invariance-plots-d}Loss (RI-MNIST)]{
%     \includegraphics[width=0.23\textwidth]{\toplevelprefix/chapters/chapter4/figs/redunet/mnist1d/class_all/loss-traintest.pdf}
%     }
%     \vskip -0.1in
%     \subfigure[\label{fig:1d-invariance-plots-e}$\X_{\text{shift}}$ (TI-MNIST)]{
%     \includegraphics[width=0.22\textwidth]{\toplevelprefix/chapters/chapter4/figs/redunet/mnist2d/class_all/heatmap-X_translate_train_all.pdf}
%     }
%     \subfigure[\label{fig:1d-invariance-plots-f}$\bar{\Z}_{\text{shift}}$ (TI-MNIST)]{
%     \includegraphics[width=0.22\textwidth]{\toplevelprefix/chapters/chapter4/figs/redunet/mnist2d/class_all/heatmap-Z_translate_train_all.pdf}
%     }
%     \subfigure[\label{fig:1d-invariance-plots-g}Similarity (TI-MNIST)]{
%     \includegraphics[width=0.23\textwidth]{\toplevelprefix/chapters/chapter4/figs/redunet/mnist2d/class_all/sample_angle_combined-Z-translate_train_all-vs-translate_test_all.pdf}
%     }
%     \subfigure[\label{fig:1d-invariance-plots-h}Loss (TI-MNIST)]{
%     \includegraphics[width=0.23\textwidth]{\toplevelprefix/chapters/chapter4/figs/redunet/mnist2d/class_all/loss-traintest.pdf}
%     }
%     \vskip -0.1in
