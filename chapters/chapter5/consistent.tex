...
all modern autoencoding frameworks are instead based on a different,
probabilistic autoencoding framework, which we will study now.
% \sdb{Moving the below to Chapter 2.}
...
\sdb{Add summary material for the autoencoder part.}
