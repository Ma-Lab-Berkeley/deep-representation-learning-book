...
\end{equation}
This is known as the {\em matching, streching, and projection} (MSP) algorithm proposed by \cite{Zhai-2020}. It was shown that under broad conditions that such a greedy algorithm indeed converges to the correct solution at a superlinear rate.
