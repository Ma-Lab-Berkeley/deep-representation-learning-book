...
\begin{remark}[Global Optimality of $\ell^4$ Maximization]
...
\centering
    ...
    \end{subfigure}%    
    \caption{Comparison of compact representation with learned dictionary from the MSP algorithm with the PCA bases for the MNIST image dataset.}
