...
In this section, we prove \Cref{prop:covering-number-rate-distortion}.
...
to prove \Cref{prop:covering-number-rate-distortion}. One possibility for
...
\Cref{prop:covering-number-rate-distortion}, to be somewhat onerous in our
...
\Cref{prop:covering-number-rate-distortion} under this assumption in the section
after.
...
since the content of \Cref{prop:covering-number-rate-distortion} is phrased
...
\Cref{prop:covering-number-rate-distortion}.
...
% \subsection{Proof of
% \texorpdfstring{\Cref{prop:covering-number-rate-distortion}}{Relationship
...
To realize the program above, our proof of the lower bound in \Cref{prop:covering-number-rate-distortion} will
...
obtain the desired conclusion in \Cref{prop:covering-number-rate-distortion}.
...
The distance function referenced in \Cref{def:thickening-set} is defined in
...
\begin{lemma}
    \sdb{Lower bound approximation lemma}
\end{lemma}
