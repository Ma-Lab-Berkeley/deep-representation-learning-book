...
\end{equation}
In practice, when optimizing a deep neural network, we normally do not know the exact  value of the (local) Lipschitz constant $L$. The step size $t = 1/L$ is also known as the {\em learning rate} and is usually set based on some empirical rules. 
