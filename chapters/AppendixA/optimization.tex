...
\begin{figure}
    \DP{TODO: make python simulation and include the figure}
    \caption{Norm balls under the \(\norm{\cdot}_{\Gamma}\) norm, for different, progressively poorer-conditioned, positive semidefinite matrices \(\Gamma\).}
    \label{fig:gamma_preconditioner}
\end{figure}
