...
Probably the simplest, also the most widely used, method for optimization is {\em gradient descent} (GD). It was first introduced by Cauchy in 1847. 
...
We now assume the derivative (or gradient) of $f(\x)$ is Lipschitz continuous:
\begin{equation}
