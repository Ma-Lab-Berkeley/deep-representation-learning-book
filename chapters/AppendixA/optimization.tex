...
\begin{equation}
    L^{\prime}(\theta) \implies b^{\prime}(c(\theta))c^{\prime}(\theta) \implies a^{\prime}(b(c(\theta)))b^{\prime}(c(\theta))c^{\prime}(\theta)
\end{equation}
...
\begin{itemize}
    \item If the function to optimize has \textit{more outputs than inputs}, use \textit{forward-mode AD}.
    \item If the function to optimize has \textit{more inputs than outputs}, use \textit{reverse-mode AD}.
\end{itemize}
