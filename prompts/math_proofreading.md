...
In this book we use many mathematical notations. We have tried to
keep them as coherent as possible. Please point out any inconsistencies.
...
\begin{itemize}
    \item The base probability measure is \(\Pr\), i.e., the
        ...
        subscript, i.e., \(\Pr_{\vx \sim \mu}[\vx \in S]\). If two random
        variables $\vx$ and $\vx'$ have the same distribution, we write $\vx
        \equid \vx'$.
