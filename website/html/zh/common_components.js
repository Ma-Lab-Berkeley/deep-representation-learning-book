...
(function(){
  window.BOOK_COMPONENTS = {
    ...
    aiHelpers: {
      title: 'AI 助手',
      intro: '为了帮助人们学习或使用这本书，我们将开发并持续改进定制化的AI助手和工具，以帮助人们学习这本书、教授这本书或利用这本书进行研究。目前，我们已经开发了BookQA系列，可以回答关于这本书的问题。我们已经开发了两个模型，并在Hugging Face上开源（见下文）。特别是，BookQA-7B-Instruct模型已部署在我们的网站上（"Ask AI"按钮）。更多AI助手即将推出。',
