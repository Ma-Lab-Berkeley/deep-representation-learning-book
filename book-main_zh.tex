...
% Chinese language support (fontset=none avoids Script=CJK warnings with Fandol)
\usepackage[UTF8,linespread=1.08,fontset=none]{ctex}
...
% Override EngC's \spacedheader to avoid soul reconstruction errors with CJK
\makeatletter
\@ifclassloaded{EngC}{
...
\phantomsection\addcontentsline{toc}{chapter}{序言}
