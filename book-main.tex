...
\newcommand{\DP}[1]{{\color{brown!50!black}{\bf DP: #1}}}
...
\chapter{Learning Linear and Independent Structures (Pai and Sam)}
...
\chapter{Informative Representations via Deep Networks (Yu)}
...
\chapter{Self-Consistent Representations via Closed-Loop Transcription (Pai)}
