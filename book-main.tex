...
\@ifclassloaded{EngC}{
  ...
  \author{
    ...
    University of California, Berkeley \\[\baselineskip]
    \textbf{Druv Pai}$^*$, University of California, Berkeley \\[\baselineskip]
    \textbf{Peng Wang}, University of Michigan \& 
    University of Macau \\[\baselineskip]
    \textbf{Yi Ma},   University of California, Berkeley \& University of Hong Kong \\[3in]
    \footnotesize
...
\addcontentsline{toc}{chapter}{\numberline{}Declaration of Open Source}
...
\subfile{chapters/chapter3/compression}

\subfile{chapters/chapter4/representation}

\subfile{chapters/chapter5/deep-networks}

\subfile{chapters/chapter6/consistent}

\subfile{chapters/chapter7/conditional}
