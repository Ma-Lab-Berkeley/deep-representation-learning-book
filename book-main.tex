...
\makeatletter
\@ifclassloaded{EngC}{
    \title{\Huge Principles and Practice of \\ Deep Representation Learning \\[0.2em] {\fontsize{15}{18}\selectfont A Mathematical Theory of Structured Memory}}
    \author{
        \textbf{Sam Buchanan}$^*$, 
    ...
    \title{\huge Principles and Practice of Deep Representation Learning}
