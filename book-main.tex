...
\makeatletter
\@ifclassloaded{EngC}{
    \title{\Huge Structured Memory: Learning Deep Representations of Data Distributions}
    \author{
        ...
        \textbf{Yi Ma},   University of California, Berkeley \&
        University of Hong Kong \\[3in]
        \footnotesize
        ...
        use in derivative
        works.\\  Copyright \Pisymbol{psy}{227} 2025 Sam Buchanan,
    ...
    \author{\vspace{0.5cm}
        \textbf{Sam Buchanan}$^*$, Toyota Technological Institute at Chicago \&
        University of California, Berkeley \vspace{1cm}\\
        \textbf{Druv Pai}$^*$, University of California, Berkeley
        \vspace{1cm} \\
        \textbf{Peng Wang}, University of Michigan \&
        University of Macau  \vspace{1cm} \\
        \textbf{Yi Ma},   University of California, Berkeley \&
